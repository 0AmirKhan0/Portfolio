          ...
          >
            <PinContainer title={link} href={link}>
              <div className="relative flex items-center justify-center sm:w-[570px] w-[80vw] overflow-hidden sm:h-[40vh] h-[30vh] mb-10">
                <div className="relative w-full h-full overflow-hidden lg:rounded-3xl rounded-md bg-[#13162d]">
                  <img src="/bg.png" alt="bg-img" />
                </div>
                <img
                  src={img}
                  alt={title}
                  className="z-10 absolute top-auto h-[90%] w-full rounded-md"
                />
              </div>
                  ...
                  {iconLists.map((icon, index) => (
                    ...
                    >
                      <img
                        src={icon}
                        alt={icon}
                        className="p-2 w-12 h-12 lg:w-10 lg:h-10"
                      />
                    </div>
                  ))}
                </div>
